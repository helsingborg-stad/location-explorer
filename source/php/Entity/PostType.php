...
class PostType
{
    ...
    public function registerPostType() : string
    {
        $labels = array(
            ...
            'add_new'             => sprintf(__('Add new %s', 'location-explorer'), $this->nameSingular),
            ...
            'new_item'            => sprintf(__('New %s', 'location-explorer'), $this->nameSingular),
            'view_item'           => sprintf(__('View %s', 'location-explorer'), $this->nameSingular),
            'search_items'        => sprintf(__('Search %s', 'location-explorer'), $this->namePlural),
            'not_found'           => sprintf(__('No %s found', 'location-explorer'), $this->namePlural),
            'not_found_in_trash'  => sprintf(__('No %s found in trash', 'location-explorer'), $this->namePlural),
